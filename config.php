...
return [
	...
	'admin-notices' => [
		...
		'suggestions_message' 			=> "<strong>Speed Demon</strong> has no settings page. Instead, use the following defined constants to control functionality (default settings are shown below) by copying into your wp-config file and changing their settings as desired (the more you can enable, the better). These functions are powerful, but they follow all WordPress coding standards. <strong>If any given function crashes your site, it is because you have a plugin or theme installed that does not follow best practices, so do us a favor and do not send us hate mail (or negative reviews) because of your horribly coded plugin or theme.</strong> You can also try testing things out first on a staging site first. In an emergency you can recover your crashed website by logging in to SFTP and deleting the plugin folder (wp-content/plugins/speed-demon-littlebizzy)<br><br>define('DELETE_EXPIRED_TRANSIENTS', true);<br>define('DELETE_EXPIRED_TRANSIENTS_HOURS', '6');<br>define('DELETE_EXPIRED_TRANSIENTS_MAX_EXECUTION_TIME', '10');<br>define('DELETE_EXPIRED_TRANSIENTS_MAX_BATCH_RECORDS', '50');<br>define('DISABLE_ADMIN_AJAX', true);<br>define('DISABLE_CART_FRAGMENTS', true);<br>define('DISABLE_EMBEDS', true);<br>define('DISABLE_EMBEDS_ALLOWED_SOURCES', 'twitter, youtube');<br>define('DISABLE_EMOJIS', true);<br>define('DISABLE_JQUERY_MIGRATE', true);<br>define('DISABLE_POST_VIA_EMAIL', true);<br>define('DISABLE_XML_RPC', true);<br>define('HEADER_CLEANUP', true);<br>define('INDEX_AUTOLOAD', true);<br>define('INDEX_AUTOLOAD_REGENERATE', true);<br>define('INLINE_STYLES', true);<br>define('MINIFY_HTML', true);<br>define('REMOVE_QUERY_STRINGS', true);<br>define('REMOVE_QUERY_STRINGS_ARGS', 'v,ver,version');<br><br>%plugin% recommends the following free plugins:",
		'suggestions'					=> [
